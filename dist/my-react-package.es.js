...
function fr() {
  if (Oe) return D;
  Oe = 1;
  var V = Ce, w = Symbol.for("react.element"), U = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, A = V.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, I = { key: !0, ref: !0, __self: !0, __source: !0 };
  function P(b, c, T) {
    var p, h = {}, E = null, W = null;
    T !== void 0 && (E = "" + T), c.key !== void 0 && (E = "" + c.key), c.ref !== void 0 && (W = c.ref);
    for (p in c) m.call(c, p) && !I.hasOwnProperty(p) && (h[p] = c[p]);
    if (b && b.defaultProps) for (p in c = b.defaultProps, c) h[p] === void 0 && (h[p] = c[p]);
    return { $$typeof: w, type: b, key: E, ref: W, props: h, _owner: A.current };
  }
...
function cr() {
  return Se || (Se = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    function Ie(e) {
      return !!(typeof e == "string" || typeof e == "function" || e === m || e === I || Ae || e === A || e === T || e === p || Fe || e === W || xe || ke || De || typeof e == "object" && e !== null && (e.$$typeof === E || e.$$typeof === h || e.$$typeof === P || e.$$typeof === b || e.$$typeof === c || // This needs to include all possible module reference object
...
var dr = Z.exports;
const pr = () => /* @__PURE__ */ dr.jsx("div", { children: "Hello, this is my React component!" });
export {
  pr as default
};
